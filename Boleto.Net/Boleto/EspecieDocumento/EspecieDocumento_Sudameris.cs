    ...
    public class EspecieDocumento_Sudameris: AbstractEspecieDocumento, IEspecieDocumento
    {
        ...
        public static EspeciesDocumento CarregaTodas()
        {
            try
            {
                ...
                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.NotaPromissoria);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.NotaSeguro);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.MensalidadeEscolar);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.Recibo);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.Contrato);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.Cosseguros);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.DuplicataServico);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.LetraCambio);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.NotaDebito);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.DocumentoDivida);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.EncargosCondominais);
                alEspeciesDocumento.Add(obj);

                obj = new EspecieDocumento_Sudameris((int)EnumEspecieDocumento_Sudameris.Diversos);
                alEspeciesDocumento.Add(obj);
