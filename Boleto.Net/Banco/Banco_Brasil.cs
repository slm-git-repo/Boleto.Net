...
namespace BoletoNet
{
    ...
    internal class Banco_Brasil : AbstractBanco, IBanco
    {
        ...
        public override void ValidaBoleto(Boleto boleto)
        {
            ...
            if (boleto.Carteira.Equals("17"))
            {
                if (boleto.Cedente.Convenio.ToString().Length != 7)
                    throw new NotImplementedException(string.Format("Para a carteira {0}, o número do convênio são de 7 posições", boleto.Carteira));
        ...
        internal static string Mod11(string value)
        {
